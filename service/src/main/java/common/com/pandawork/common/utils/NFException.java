...
//    GoodStudentNotNull("获取是否为好学生为空",10012),
    ...
    PersonNameNotNull("获取人物name为空",101),
    BirthdayNotNull("获取人物birthday为空",102),
    DepartmentNotNull("获取人物department为空",103),
    TeamNotNull("获取人物team为空",104),
    CommentNotNull("获取人物comment为空",105),
